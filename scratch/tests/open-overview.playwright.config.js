...
module.exports = defineConfig({
  ...
  webServer: { command: "node open-overview-static-server.mjs ../../vercel-public 4174", cwd: __dirname, url: "http://127.0.0.1:4174/web/open-overview/index.html", reuseExistingServer: true, timeout: 15_000 },
  projects: [{
    name: "chromium",
    use: {
