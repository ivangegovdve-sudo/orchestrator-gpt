...
; General-purpose automation for running Codex prompt chains defined in codex_chains.json.
...
; -------------------------
; Utility: JSON loader (JXON light)
; -------------------------
JSON_Load(jsonText) {
...
RunCurrentStep() {
    Global CurrentChain, CurrentStepIndex, CurrentStep, DefaultIdle, LastClipboard, LastChangeTick, Mode, Monitoring_IdleThreshold
...
MonitorOutput:
    Global LastClipboard, LastChangeTick, CurrentStep, CurrentChain, CurrentStepIndex, Mode, Monitoring_IdleThreshold
    if (Mode != "waiting")
        return
