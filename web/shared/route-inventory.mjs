...
export const ROUTE_INVENTORY = Object.freeze([
  ...
  { id: 'council', href: '/web/council/', state: 'main-atlas', parent: 'forest-hub', placement: 'Signals & Systems', prefetch: true, prerender: false, label: 'Councils', trailId: 'signals', connectionIds: ['ai-research', 'library', 'open-dashboard'] },
  ...
  { id: 'morning-news', href: '/web/morning-news/', state: 'main-atlas', parent: 'forest-hub', placement: 'Signals & Systems', prefetch: true, prerender: false, label: 'The Drop', trailId: 'signals', connectionIds: ['forest-hub', 'library', 'calendar'] },
  ...
  { id: 'open-dashboard', href: '/web/open-dashboard/', state: 'main-atlas', parent: 'forest-hub', placement: 'Signals & Systems', prefetch: true, prerender: false, label: 'Open Dashboard', trailId: 'signals', aliasPaths: ['/web/open-dashboard/github/', '/web/open-dashboard/openrouter/', '/web/open-dashboard/catalogues/', '/web/open-dashboard/matrix/'], connectionIds: ['library', 'council', 'ai-research', 'power-law-odyssey'] },
  ...
  { id: 'ai-research', href: '/web/ai-research/', state: 'hub-trail', parent: 'forest-hub', placement: 'Machine Grove', prefetch: true, prerender: false, label: 'Artificial Self research archive', trailId: 'machine', connectionIds: ['council', 'c2c-dolphin', 'c2c-self', 'avatar-playground'] },
