...
export const ROUTE_INVENTORY = Object.freeze([
  ...
  { id: 'open-dashboard', href: '/web/open-dashboard/', state: 'main-atlas', parent: 'forest-hub', placement: 'Signals & Systems', prefetch: true, prerender: false, label: 'Open Dashboard', trailId: 'signals', aliasPaths: ['/web/open-dashboard/github/', '/web/open-dashboard/openrouter/'], connectionIds: ['library', 'council', 'ai-research', 'power-law-odyssey'] },
