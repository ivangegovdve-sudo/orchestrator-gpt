...
export const ROUTE_INVENTORY = Object.freeze([
  ...
  { id: 'ai-research', href: '/web/ai-research/', state: 'hub-trail', parent: 'forest-hub', placement: 'Machine Grove', prefetch: true, prerender: false, label: 'Research archive (naming review)', trailId: 'machine', connectionIds: ['council', 'c2c-dolphin', 'c2c-self', 'avatar-playground'] },
