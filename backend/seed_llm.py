...
urls_to_seed = [
    ...
    {"name": "Deepagents Readme", "url": "https://github.com/langchain-ai/deepagents/blob/main/README.md"},
    {"name": "Deepagents Overview", "url": "https://docs.langchain.com/oss/python/deepagents/overview"},
